  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav" >
        <li class="active"><a href="Accueil.php"><img src="Icones/accueil.ico" alt="Accueil"> Accueil </a></li>
        ...
        <div class="col-sm-12">
          <div class="panel panel-primary text-center">
            <div class="panel-heading">Partagez un message, une photo, une vidéo, un lien</div>
              ...
              <a href="Accueil_post.php" class="boutonevent" ><button type="button" class="btn btn-primary">
                <img src="Icones/ecrire.ico" alt="Ecrire un post">
                Ecrire un post
              </button></a>
              <a href="Accueil_videos.php" class="boutonevent" ><button type="button" class="btn btn-primary">
                <img src="Icones/video.ico" alt="Poster une vidéo">
                Poster une vidéo
              </button></a>
              <a href="Accueil_evenements.php" class="boutonevent" ><button type="button" class="btn btn-primary">
                <img src="Icones/event.ico" alt="Créer un évènement">
                Évènement
              </button></a>
              <a href="Accueil_photos.php" class="boutonevent" ><button type="button" class="btn btn-primary">
                <img src="Icones/image.ico" alt="Poster une photo">
                Ajouter une photo
              </button></a>
              <form action="Video_creation.php" method="post" >
                <div class="form-group">
                  <label for="url_evenement">Url:</label>
                  <input type="text" class="form-control" name="url_video" placeholder="lieu" >
                </div>
                 <div class="form-group">
                   <label for="nom_evenement">Lieu:</label>
                   <input type="text" class="form-control" name="lieu_video" placeholder="lieu" >
                 </div>
                 <div class="form-group">
                   <label for="date_evenement">Date:</label>
                   <input type="date" class="form-control" name="date_video" >
                 </div>
                 <div class="form-group">
                   <label for="heure_evenement">Heure:</label>
                   <input type="time" class="form-control" name="heure_video"  >
                 </div>
                 <div class="form-group">
                   <label for="ressenti_photo">Ressenti:</label>
                   <input type="text" class="form-control" name="ressenti_video" placeholder="ressenti" >
                 </div>
                 <div class="form-group">
                   <label for="activite_photo">Activité:</label>
                   <input type="text" class="form-control" name="activite_video" placeholder="activite" >
                 </div>
               </br>
               <p class="accueil_boutons">
                 <button type="submit" class="btn btn-default">Ajouter</button> </p>
             </form>
            </div>
            </div>
          </div>
