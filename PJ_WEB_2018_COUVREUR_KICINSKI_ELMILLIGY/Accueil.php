...
<div class="container col-lg-10 text-center">
 ...
 echo " " . $data['nom'] ;
        ...
        <img  class="img" src="<?php echo $repertoire.$profile_pic; ?>" alt="photo_auteur" width="120" />
      </div>
      </div>
      <div class="panel panel-primary text-center">
          ...
          <div class="panel-body text-left">
            <div class="row">
              ...
              while($row = mysqli_fetch_array($result)){
                  ...
                  {
                      echo " <img class='img'  src=". $repertoire.$row['photo_auteur'] ." alt='photo_auteur' width='100' />" . " " . $row['prenom'] . " " . $row['nom'] . "</br>";
    ...
    <div class="col-sm-2 well">
      ...
      <div class="well">
      <a href="https://www.paypal.com/fr/home"> Faites des dons </a>
      </div>
      <div class="well">
        <p>ADS</p>
      </div>
