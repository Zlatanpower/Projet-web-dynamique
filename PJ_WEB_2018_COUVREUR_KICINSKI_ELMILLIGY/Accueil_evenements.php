        ...
        <div class="col-sm-12">
          <div class="panel panel-primary text-center">
            ...
            <div class="panel-body">
              ...
              <form action="Evenement_creation.php" method="post">
              <div class="form-group">
              <label for="nom_evenement">Nom de l'évènement:</label>
              <input type="text" class="form-control" name="nom_evenement" placeholder="nom" required>
              </div>
              <div class="form-group">
              <label for="lieu_evenement">Lieu:</label>
              <input type="text" class="form-control" name="lieu_evenement" placeholder="lieu" required>
              </div>
              <div class="form-group">
              ...
              <input type="time" class="form-control" name="heure_evenement"  required>
              </div>
              </br>
              <p class="accueil_boutons">
              <button type="submit" class="btn btn-default">Créer</button> </p>
              </form>
              </div>
          </div>
          </div>
