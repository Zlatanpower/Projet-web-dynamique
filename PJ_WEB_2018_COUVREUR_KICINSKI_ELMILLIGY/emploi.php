  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav" >
        ...
        <li class="active"><a href="emploi.php"><img src="Icones/emploi.ico" alt="Emplois"> Emplois </a></li>
        ...
        <div class="row">
            <div class="col-xs-5"> </div>
              ...
              <div class="panel panel-primary">
                ...
                <?php if($_SESSION["type_utilisateur"]=='Administrateur') echo "<button type='button' class='btn btn-primary'>Ajoutez une offre d'emploi</button></div>";
                ?>
