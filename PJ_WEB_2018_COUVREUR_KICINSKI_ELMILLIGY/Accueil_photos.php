        ...
        <div class="col-sm-12">
          <div class="panel panel-primary text-center">
            <div class="panel-heading">Partagez un message, une photo, une vidéo, un lien</div>
             ...
             <br><form action="Photo_creation.php" method="post" >
                <input type="file" name="image"/>
                <div class="form-group">
                  <label for="nom_evenement">Lieu:</label>
                  <input type="text" class="form-control" name="lieu_photo" placeholder="lieu" >
                </div>
                <div class="form-group">
                  <label for="date_evenement">Date:</label>
                  <input type="date" class="form-control" name="date_photo" >
                </div>
                <div class="form-group">
                  <label for="heure_evenement">Heure:</label>
                  <input type="time" class="form-control" name="heure_photo"  >
                </div>
                <div class="form-group">
                  <label for="ressenti_photo">Ressenti:</label>
                  <input type="text" class="form-control" name="ressenti_photo" placeholder="ressenti" >
                </div>
                <div class="form-group">
                  <label for="activite_photo">Activité:</label>
                  <input type="text" class="form-control" name="activite_photo" placeholder="activite" >
                </div>
              </br>
